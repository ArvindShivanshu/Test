...
uri = "mongodb+srv://namdev04777:x02AY8WYCvt44t2q@cluster0.xj77ohs.mongodb.net/?retryWrites=true&w=majority&tls=true&tlsAllowInvalidCertificates=true"

bot_token = "7030821273:AAHOxBx5VVA33zGsOeTxXFD10vs9nKKr3H8" # Telegram bot token
...
def menu(user_id):
    start_message = (f"<b>Welcome to  Future Here Now  ❤️\n\n"
...
def send_join_message(message):
    ...
    if not chat_member(user_id): # use more channels ["channel1","channel2"]
        ...
        channels = [" joinxyza" ," +NEF3KcQzI5BkMzc1"
          " Earning_Flash",
          " tehsiltech",
          " TECH_MISMAMUL",
          " +hf5sPpkUse1iYTM1",
  ...
  # Update with your channel usernames
        ...
        for channel in channels:
            join_markup.add(InlineKeyboardButton(text="Join " , url="https://t.me/" + channel[1:]))
        verify_but = InlineKeyboardButton(text="Verify", callback_data="verify")

        join_markup.add(verify_but)
